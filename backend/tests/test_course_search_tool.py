...
class TestCourseSearchToolExecute(unittest.TestCase):
    ...
    def test_execute_successful_search_with_results(self):
        ...
        mock_results = SearchResults(
            documents=["This is content about Python variables", "More content about data types"],
            metadata=[
        ...
        self.mock_vector_store.get_lesson_link.return_value = "https://example.com/lesson/1"
        ...
        self.assertEqual(self.search_tool.last_sources[0]["display"], "Python Basics - Lesson 1")
    ...
    def test_execute_search_with_course_filter(self):
        ...
        result = self.search_tool.execute("advanced topics", course_name="Advanced Python")
    ...
    def test_execute_search_with_lesson_filter(self):
        ...
        self.mock_vector_store.search.return_value = mock_results
        self.mock_vector_store.get_lesson_link.return_value = "https://example.com/lesson/5"
    ...
    def test_execute_search_with_both_filters(self):
        ...
        self.mock_vector_store.search.return_value = mock_results
        self.mock_vector_store.get_lesson_link.return_value = "https://example.com/lesson/2"
        
        # Execute with both filters
        result = self.search_tool.execute("ML algorithms", course_name="Data Science", lesson_number=2)
    ...
    def test_execute_empty_results_with_filters(self):
        ...
        result = self.search_tool.execute("nonexistent", course_name="Python Basics", lesson_number=1)
    ...
    def test_format_results_with_lesson_links(self):
        ...
        self.mock_vector_store.search.return_value = mock_results
        self.mock_vector_store.get_lesson_link.return_value = "https://example.com/web-dev/lesson-1"
        ...
        self.assertEqual(self.search_tool.last_sources[0]["link"], "https://example.com/web-dev/lesson-1")
    ...
    def test_format_results_without_lesson_number(self):
        ...
        self.assertEqual(len(self.search_tool.last_sources), 1)
        self.assertEqual(self.search_tool.last_sources[0]["display"], "Machine Learning")
    ...
    def test_sources_tracking_and_reset(self):
        ...
        self.mock_vector_store.search.return_value = mock_results
        self.mock_vector_store.get_lesson_link.side_effect = ["https://example.com/lesson1", "https://example.com/lesson2"]
        ...
        # Verify sources are tracked
        self.assertEqual(len(self.search_tool.last_sources), 2)
        self.assertEqual(self.search_tool.last_sources[0]["display"], "Course 1 - Lesson 1")
        self.assertEqual(self.search_tool.last_sources[1]["display"], "Course 2 - Lesson 2")
...
class TestToolManagerIntegration(unittest.TestCase):
    ...
    def test_register_tool(self):
        ...
        self.assertEqual(self.tool_manager.tools["search_course_content"], self.search_tool)
    ...
    def test_multiple_tools_source_management(self):
        ...
        self.search_tool.last_sources = [{"display": "Search Tool Source", "link": None}]
